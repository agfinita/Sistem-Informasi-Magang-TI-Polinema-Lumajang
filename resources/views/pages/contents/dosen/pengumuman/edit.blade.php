...
<body>
                        ...
                        <div class="row">
                            <div class="col-12 col-md col-lg">
                                ...
                                <div class="card">
                                    ...
                                    <form id="update-form" action="{{ url('/dosen/pengumuman/edit/' . $pengumuman->id) }}" method="POST">
                                        @method('patch')
                                        @csrf
                                        <div class="card-body">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{ url('/dosen/pengumuman') }}" class="btn btn-warning m-2">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    <script>
        var redirectUrl = "{{ url('/dosen/pengumuman') }}";
    </script>
