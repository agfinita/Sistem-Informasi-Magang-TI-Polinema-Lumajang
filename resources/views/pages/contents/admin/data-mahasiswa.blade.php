                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="nav-link" href="{{ url('/dataMahasiswa') }}"><span>Mahasiswa</span></a></li>
                            </ul>
                        </li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="col-md-6 mx-2 my-auto">
                                        ...
                                        <button type="submit" class="btn btn-success">
                                            <a href="{{ url('/formDataMahasiswa') }}" class="text-decoration-none text-white">
                                                <span>
                                            ...
                                            <table id="example" class="display nowrap" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <a href="{{ url('/updateDataMahasiswa/' . $mhs->id) }}">
                                                                    <button class="btn btn-sm btn-warning mx-1">
                                                                        <i class="ion ion-edit" data-pack="default" data-tags="change, update, write, type, pencil"></i>
                                                                    </button>
                                                                </a>

                                                                <form action="{{ url('/dataMahasiswa/' . $mhs->id) }}" method="POST" onsubmit="return confirm('Yakin hapus data?')">
                                                                    @method('DELETE')
                                                                    @csrf
