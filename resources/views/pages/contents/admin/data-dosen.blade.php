                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="nav-link" href="{{ url('/dataDosen') }}"><span>Dosen</span></a></li>
                                                ...
                                                <tbody>
                                                    @foreach ($dosen as $d)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    <a href="{{ url('/updateDataDosen/' . $d->id) }}">
                                                                    ...
                                                                    <form action="{{ url('/dataDosen/' . $d->id) }}"
                                                                        method="POST"
