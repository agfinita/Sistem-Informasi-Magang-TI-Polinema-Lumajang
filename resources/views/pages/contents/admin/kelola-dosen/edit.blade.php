...
<body>
                            ...
                            <div class="col-12 col-md col-lg">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Update user dosen</h4>
                                    </div>

                                    <form id="update-form" action="{{ url('/kelola-pengguna/dosen/edit/' . $users->id) }}"
                                        method="POST">
                                        @method('patch')
                                        @csrf
                                        <div class="card-body">
                                            ...
                                            <fieldset class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="gridRadios" id="admin" value="Admin" disabled>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="datetime-local" name="date_updated"
                                                        id="date_updated" class="form-control"
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                ...
                                                <a href="{{ url('/kelola-pengguna/dosen') }}" class="btn btn-warning m-2">Kembali</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        var redirectUrl = "{{ url('/kelola-pengguna/dosen') }}";
    </script>
