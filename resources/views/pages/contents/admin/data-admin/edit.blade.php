...
<body>
                        ...
                        <div class="row">
                            <div class="col-12 col-md col-lg">
                                ...
                                <div class="card">
                                    ...
                                    <form id="update-form" action="{{ url('/data-pengguna/admin/edit/' . $admin->id) }}" method="POST" autocomplete="off">
                                        @method('patch')
                                        @csrf
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input readonly type="text" class="form-control" id="nip" name="nip" placeholder="Masukkan NIM" value={{ $admin->nip }}>
                                                </div>
                                            </div>
    ...
    <script>
        var redirectUrl = "{{ url('/data-pengguna/admin') }}";
    </script>
