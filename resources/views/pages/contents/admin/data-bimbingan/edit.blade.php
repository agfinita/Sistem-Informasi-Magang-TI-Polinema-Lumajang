                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li class="active"><a class="nav-link" href="{{ url('/admin/data-bimbingan-mahasiswa') }}"><i class="ion ion-android-list"></i><span>Dosen Pembimbing</span></a></li>
                        </li>
                                ...
                                <div class="card">
                                    ...
                                    <form id="update-form" action="{{ url('/admin/data-bimbingan-mahasiswa/edit/' . $dataBimbingan->id) }}" method="POST">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{ url('/admin/data-bimbingan-mahasiswa') }}" class="btn btn-warning m-2">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
