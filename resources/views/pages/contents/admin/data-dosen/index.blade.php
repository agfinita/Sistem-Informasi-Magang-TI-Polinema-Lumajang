            ...
            <div class="main-sidebar sidebar-style-2" <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="nav-link" href="{{ url('/') }}"><i class="ion ion-speedometer"
                                data-pack="default" data-tags="travel, accelerate"></i><span>Dashboard</span></a></li>
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a class="nav-link"
                                    href="{{ url('/data-pengguna/dosen') }}"><span>Dosen</span></a></li>
                            <li><a class="nav-link"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="{{ url('/kelola-pengguna/admin') }}"><span>Admin</span></a>
                            </li>
                            <li><a class="nav-link" href="{{ url('/kelola-pengguna/dosen') }}"><span>Dosen</span></a>
                            </li>
                            <li><a class="nav-link"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="{{ url('/admin/mahasiswa/pengajuan-magang') }}">Permintaan
                                    Magang</a></li>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <a
                                                                        href="{{ url('/data-pengguna/dosen/edit/' . $d->id) }}">
                                                                    ...
                                                                    <form id="delete-form-{{ $d->id }}"
                                                                        action="{{ url('/data-pengguna/dosen/' . $d->id) }}"
                                                                        method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button type="button"
