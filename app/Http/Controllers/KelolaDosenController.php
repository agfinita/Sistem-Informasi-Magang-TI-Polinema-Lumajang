...
class KelolaDosenController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //return redirect('/tableUserDosen')->with('status', 'Data added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::transaction( function () use ($validatedData, $users) {
            ...
            // Update data dosen terkait user
            $dosen  = Dosen::where('nip', $users->username)->first();
            if ($dosen) {
                $dosen->update([
                    'nip'       => $users->username,
                    'email'     => $users->email,
        ...
        // Redirect halaman: sudah ada di modules.sweetalert.js
        //return redirect('/kelola-pengguna/dosen');
    }
